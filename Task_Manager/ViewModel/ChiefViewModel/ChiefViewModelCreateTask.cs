...
{
    public class ChiefViewModelCreateTask : ViewModel.BaseViewModelAll.ViewModelCreateTaskBase
    {
        ...
        public ChiefViewModelCreateTask(Model.task_book task_):base(task_)
        {
        ...
        //public ChiefViewModelCreateTask(Model.task_book __task_Book)
        //{
        //    if (__task_Book == null)
        //    {
